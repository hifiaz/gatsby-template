      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            activity = report.activityTimer(`Generating CSS`);
...
var _require = require(`../reporter/errors`),
    formatStaticBuildError = _require.formatStaticBuildError;
...
function reportFailure(msg, err) {
  report.log(``);
  report.panic(msg, err.name !== `WebpackError` ? err : formatStaticBuildError(err));
}
